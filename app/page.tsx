              ...
              {[
                {
                  parts: [
                    ...
                    { text: ' that ', colored: false },
                    { text: 'manages corporate sponsorship', colored: true },
                    { text: ' across Junior A hockey leagues and large minor hockey associations.', colored: false },
                  ]
                },
                {
                  parts: [
